                        ...
                        if (model.isSendCodeError)
                          Padding(
                            ...
                            child: Text(
                              ...
                              model.sendCodeErrorAttemptCount.toString()
                            ]),
                          ),
                        Container(
                          decoration: BoxDecoration(
                          ...
                          child: CustomTextChildButton(
                            ...
                            onPressed: !model.isLoading
                                ? () async {
                                    ...
                                    if (!_sendCodeformKey.currentState!
                                        .validate()) return;
                                    ...
                                    await model.onOtpVerifyButtonPressed(
                                      ...
                                      onFailForView: () async {
                                        ...
                                        if (model.sendCodeErrorAttemptCount ==
                                            -1) {
                                          model.navBack();
                                          await showFlexibleBottomSheet(
                                            initHeight: 0.95,
