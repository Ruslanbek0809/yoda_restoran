                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 15.w),
                      Text(
                        model.currentUser?.mobile ?? '+993 65555555',
                        style: kts18BoldText,
                      ),
                    ],
                  ),
                        ...
                        if (_tempDateTime != null) {
                          ...
                          if (_tempDateTime.hour < startHour ||
                            ...
                            await showDateRangeErrorFlashBar(
                              context: context,
                              msg: Text(LocaleKeys.requiredWorkingHoursForRes,
                          ...
                          //*========== CHECKS MINUTES PART =========== ///
                            ...
                            if (tempHourMin < startTempHourMin ||
                              ...
                              model.updateDateTimeForDelivery(_tempDateTime);
                            }
                          }
                        }
                      },
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      context.locale ==
                                          ...
                                          ? model.selectedPaymentType!.nameTk!
                                          : model.selectedPaymentType!.nameRu!,
                                      style: kts16Text,
                                    ),
                                  ],
                                ),
