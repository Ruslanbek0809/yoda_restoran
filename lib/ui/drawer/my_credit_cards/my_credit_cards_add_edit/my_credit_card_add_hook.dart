...
class MyCreditCardAddHook
    extends HookViewModelWidget<MyCreditCardAddViewModel> {
  const MyCreditCardAddHook({Key? key}) : super(key: key);

  @override
  Widget buildViewModelWidget(
      BuildContext context, MyCreditCardAddViewModel model) {
